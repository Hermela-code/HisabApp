...
final appRepositoryProvider = Provider<AppRepository>((ref) => SqliteAppRepository(ref.read(sqliteServiceProvider)));
...
final AppRepository appRepository = SqliteAppRepository(SqliteService());
